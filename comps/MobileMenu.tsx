...
import { MobileMenuWrapper, MobileUl, MobileTitle, MobileSearchBar, MobileHead } from "../styled/mobile-menu";
...
import { StyledCaretUp, StyledCaretDown, StyledClose, StyledSerchIcon } from "../styled/icons";
  ...
  return (
    <MobileMenuWrapper>
      <MobileHead>
        ...
        >
            <StyledClose style={{marginRight: '3rem'}} />
          <Link href="/" passHref>
            <StyledLink margin="0">
      ...
      <CustomSearch>
          ...
          <StyledCaretDown style={{margin: 'auto .8rem auto .8rem'}} color="#000" />
