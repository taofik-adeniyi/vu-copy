      ...
      <Portal>
        <Modal cancel={false} width="90%" height="100%">
          <CustomShoot>
            ...
            >
              <div>
                <h1 style={{ fontFamily: "Overlock", fontSize: "32px" }}>
                  Create a custom Shoot
                </h1>
              </div>
              <div>
                <StyledCancelIcon />
            ...
            >
              ...
              >
                ...
                in reprehenderit in voluptate velit esse cillum dolores.
              </div>
            </div>
            <div
              style={{
            ...
            >
              <div style={{ display: "flex", gap: "20px" }}>
                ...
                <Tips
                  ...
                  description="Choose the category and subcategory that best fits your shoot request."
                  eg="For example:
If you are looking for a logo, you should choose 'Logo Design' within the 'Graphics & Design' category."
            ...
            >
              <StyledButton hcolor="#000" hover="#000">
                Back
              </StyledButton>
              <StyledButton background="#93D500" hcolor="#000" hover="#000">
                submit offer
              </StyledButton>
            </div>
          </CustomShoot>
      ...
      <div style={{ color: "white", width: "90%", margin: "40px auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <div>
            <h1 style={{ fontFamily: "Overlock" }}>Shoot Request</h1>
          </div>
          <div>
            <input
              type="text"
        ...
        <div style={{ background: "#17191C", padding: "10px 0" }}>
          ...
          >
            <div style={{ fontSize: "19px", fontFamily: "Overlock" }}>
              BUYER'S SHOOT REQUEST
            </div>
            <div
              style={{
                border: "1px solid #D1CFCF",
          ...
          <StyledTable>
            ...
            <tr>
              ...
              <td style={{ display: "flex", gap: "20px" }}>
                ...
                >
                  Get access to upcoming events, exclusive courses, articles,
                  Latest events and hangouts, Podcast, competitions and more...
                  <span style={{ color: "#1EAAB2", cursor: "pointer" }}>
                    see more
                  </span>
                </div>
              </td>
